    ...
    stages {
        ...
        stage('Buil stage'){
            steps {
                ...
                withDockerRegistry(credentialsId: 'ACR_LAB', url: 'https://azureregistryjenkins.azurecr.io') {
                    ...
                    sh 'docker run -d -p 8081:8081 --name nodejs azureregistryjenkins.azurecr.io/nodejs:v2'
                }
            }
        }
    }
